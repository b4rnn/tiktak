    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if(campaign_records[0]==API_RESULT['campaign_id']):
                ...
                print(DAILY_BUDGET , START_DATE , END_DATE)
                if((RECORD_3[0])==None):
                    RECORD_3[0]='?'
                if((RECORD_3[1])==None):
                    RECORD_3[1]='?'
                ...
                RESULT = {"msg" : msg,"status":"200","location":billboard_records,"campaign":advert_records,"budget":budget_records,"design":design_records,"event":campaign_records[7],"schedule":schedule_records}
